      ...
      <div className="relative" ref={ref}>
        <DropdownMenuTrigger asChild>
          <motion.div
            ...
            onMouseEnter={() => setHovered(true)}
            onMouseLeave={() => setHovered(false)}
            className="relative flex aspect-square items-center justify-center rounded-full transition-colors duration-300 bg-gray-200 dark:bg-neutral-800 hover:bg-gray-300 dark:hover:bg-neutral-700 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/60"
          >
            <AnimatePresence>
        ...
        <DropdownMenuContent
          ...
          align="center"
          sideOffset={12}
          className="w-72 p-0 overflow-hidden border-white/15"
          style={{
        ...
        >
          ...
          <div className="p-2 space-y-1">
            ...
            <DropdownMenuItem
              asChild
              className="text-gray-300 hover:bg-white/10 focus:bg-white/10 hover:text-white focus:text-white"
            >
              <a href="/profile">
            ...
            {/* Language Selector (cycles; keep menu open) */}
            <DropdownMenuItem
              className="text-gray-300 hover:bg-white/10 focus:bg-white/10 hover:text-white focus:text-white"
              onSelect={(e) => {
                e.preventDefault();
            ...
            <DropdownMenuItem
              variant="danger"
              className="text-red-400 hover:bg-red-500/10 focus:bg-red-500/10 hover:text-red-300 focus:text-red-300"
